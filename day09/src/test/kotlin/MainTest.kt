...
class MainTest: WordSpec({
    ...
    "for part two" should ({
        "(3x3)XYZ is a tree of length 9" {
            "(3x3)XYZ".toTree(partTwo = true).length() shouldBe 9L
        }
        "X(8x2)(3x3)ABCY is a tree of length 20" {
            "X(8x2)(3x3)ABCY".toTree(partTwo = true).length() shouldBe 20L
        }
        "(27x12)(20x12)(13x14)(7x10)(1x12)A creates a tree of length 241920" {
            "(27x12)(20x12)(13x14)(7x10)(1x12)A".toTree(partTwo = true).length() shouldBe 241920L
        }
        "(25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN creates a tree of length 445" {
            "(25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN".toTree(partTwo = true).length() shouldBe 445L
        }
